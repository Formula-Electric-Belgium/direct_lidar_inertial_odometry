...
private:
    ...
    void callbackASState(const car_status_msgs::msg::ASFSMState::SharedPtr msg);
    ...
    void publishKeyframe(std::pair<std::pair<Eigen::Vector3f, Eigen::Quaternionf>, pcl::PointCloud<PointType>::ConstPtr> kf, rclcpp::Time timestamp);
    ...
    rclcpp::Subscription<car_status_msgs::msg::ASFSMState>::SharedPtr as_state_sub;
